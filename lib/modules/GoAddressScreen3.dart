...
class GoAddressScreen3 extends StatefulWidget {

  Order? order;

  GoAddressScreen3({this.order});

  @override
  _GoAddressScreen3State createState() => _GoAddressScreen3State();

}

class _GoAddressScreen3State extends State<GoAddressScreen3> {
