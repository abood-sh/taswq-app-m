...
class GoAddressScreen2 extends StatefulWidget {
  Order? order;

  GoAddressScreen2({this.order});

  @override
  _GoAddressScreen2State createState() => _GoAddressScreen2State();

}

class _GoAddressScreen2State extends State<GoAddressScreen2> {
